...
recon3d_forCancer = remove_genes(recon3d_forCancer, ['8041.1'], remove_reactions=False)
...
recon3d_forCancer.remove_reactions(
    [r for r in recon3d_forCancer.reactions if r.id[:3] == 'DM_' or r.id[:5] == 'sink_'], remove_orphans=True)
...
# Remove transcript 8041.1 (and 0?)
recon3d_forTcells = remove_genes(recon3d_forTcells, ['8041.1'], remove_reactions=False)
# Remove 'biomass_maintenance' and 'biomass_maintenance_noTrTr'
